...
(
  AUDITORIUM_TYPE   CHAR(60) PRIMARY KEY,  
  AUDITORIUM_TYPENAME  VARCHAR(60) NOT NULL         
);
...
INSERT INTO AUDITORIUM_TYPE (AUDITORIUM_TYPE, AUDITORIUM_TYPENAME) 
VALUES ('ЛК-К', 'Лекционная с установленными компьютерами');

INSERT INTO AUDITORIUM_TYPE (AUDITORIUM_TYPE, AUDITORIUM_TYPENAME) 
VALUES ('ЛБ-X', 'Химическая лаборатория');

INSERT INTO AUDITORIUM_TYPE (AUDITORIUM_TYPE, AUDITORIUM_TYPENAME) 
VALUES ('ЛБ-СК', 'Специализированный компьютерный класс');
...
(
 ...
 AUDITORIUM_TYPE      CHAR(60) NOT NULL,
