...
namespace ht    // HT API
{
	...
	extern "C" OS11_HTAPI_API BOOL removeOne      // удалить элемент в хранилище
	(
	...
	extern "C" OS11_HTAPI_API const char* getLastError  // получить сообщение о последней ошибке
	(
